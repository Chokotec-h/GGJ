...
<tileset version="1.5" tiledversion="1.7.2" name="Tileset" tilewidth="16" tileheight="16" tilecount="36" columns="9">
 ...
 <tile id="7">
  <properties>
   <property name="animated" type="bool" value="false"/>
   <property name="type" value="Secret Cookie"/>
  </properties>
 </tile>
 <tile id="8">
  <properties>
 ...
 <tile id="21">
  <properties>
   <property name="animated" type="bool" value="true"/>
   <property name="frame0" type="file" value="../Tiles/Aqua_Veil_Middle[0].png.png"/>
   <property name="frame1" type="file" value="../Tiles/Aqua_Veil_Middle[1].png.png"/>
   <property name="frame2" type="file" value="../Tiles/Aqua_Veil_Middle[2].png.png"/>
   <property name="frame3" type="file" value="../Tiles/Aqua_Veil_Middle[3].png.png"/>
   <property name="number" type="int" value="0"/>
   <property name="type" value="Door"/>
  </properties>
  <animation>
 ...
 <tile id="30">
  <properties>
   <property name="animated" type="bool" value="true"/>
   <property name="frame0" type="file" value="../Tiles/Aqua_Veil_Down[0].png.png"/>
   <property name="frame1" type="file" value="../Tiles/Aqua_Veil_Down[1].png.png"/>
   <property name="frame2" type="file" value="../Tiles/Aqua_Veil_Down[2].png.png"/>
   <property name="frame3" type="file" value="../Tiles/Aqua_Veil_Down[3].png.png"/>
   <property name="number" type="int" value="0"/>
   <property name="type" value="Door"/>
  </properties>
  <animation>
